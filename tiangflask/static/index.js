    ...
    sidebar: {
        ...
        nodes: [ 
            { id: 'ofertas', text: 'Ofertas', group: true, expanded: true, nodes: [
                { id: 'o_mias', text: 'Mías', img: 'icon-page', selected: true },
                { id: 'o_inbox', text: 'Inbox', img: 'icon-page' },
                { id: 'o_mercado', text: 'En el mercado', img: 'icon-page' },
            ]},
            { id: 'pedidos', text: 'Pedidos', group: true, expanded: true, nodes: [
                { id: 'p_mias', text: 'Mis pedidos', img: 'icon-page', selected: true },
                { id: 'p_inbox', text: 'Inbox', img: 'icon-page' },
